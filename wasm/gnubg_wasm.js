 ...
 * @returns {any}
 */
export function analyze_position(position_id, depth) {
    const ptr0 = passStringToWasm0(position_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.analyze_position(ptr0, len0, depth);
    return ret;
}
 ...
 * @returns {any}
 */
export function best_move(position_id, dice, depth) {
    const ptr0 = passStringToWasm0(position_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(dice, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.best_move(ptr0, len0, ptr1, len1, depth);
    return ret;
}
 ...
 * @param {string} position_id
 * @param {string | null} [match_score]
 * @param {number | null} [cube_value]
 * @returns {any}
 */
export function evaluate_position(position_id, match_score, cube_value) {
    const ptr0 = passStringToWasm0(position_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    var ptr1 = isLikeNone(match_score) ? 0 : passStringToWasm0(match_score, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
    const ret = wasm.evaluate_position(ptr0, len0, ptr1, len1, isLikeNone(cube_value) ? Number.MAX_SAFE_INTEGER : (cube_value) >> 0);
    return ret;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gnubg_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
